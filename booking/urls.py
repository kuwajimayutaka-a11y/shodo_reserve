...
admin_urlpatterns = [
    ...
    path('admin-dashboard/student-groups/', admin_views.student_group_list, name='admin_student_group_list'),
    path('admin-dashboard/student-groups/add/', admin_views.add_student_group, name='admin_add_student_group'),
    path('admin-dashboard/student-groups/<int:group_id>/edit/', admin_views.edit_student_group, name='admin_edit_student_group'),
    path('admin-dashboard/student-groups/<int:group_id>/delete/', admin_views.delete_student_group, name='admin_delete_student_group'),
    path('admin-dashboard/students/add/<int:family_id>/', admin_views.add_student_admin, name='admin_add_student'),
    path('admin-dashboard/families/<int:family_id>/edit/', admin_views.edit_family_admin, name='admin_edit_family'),
    path('admin-dashboard/families/<int:family_id>/delete/', admin_views.delete_family_admin, name='admin_delete_family'),
